...
function TodoForm() {
  const { categories, setOpenPanel, handleAddTodo } = React.useContext(TodoContext);
  ...
  return (
    <form className="form-container" onSubmit={handleSubmit}>
      ...
      <div className="todo-form-btn-container">
        <button onClick={handleCancel} className="todo-form-btn btn-cancel" type="button">Cancel</button>
